...
public class Admin {
    ...
    public void fix_amount_text_boxes_and_fine_type_radio_buttons_and_fees_master_list_fees_group_are_displayed_with() {

    }
    @Then("Fix Amount textBoxes and Fine Type radio buttons and Fees Master List, Fees Code are displayed")
    public void fix_amount_text_boxes_and_fine_type_radio_buttons_and_fees_master_list_fees_code_are_displayed() {

    }
    @Then("Fix Amount textBoxes and Fine Type radio buttons and Fees Master List, Amount and Action titles are displayed")
    public void fix_amount_text_boxes_and_fine_type_radio_buttons_and_fees_master_list_amount_and_action_titles_are_displayed() {
